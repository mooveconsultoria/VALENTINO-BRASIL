...
/*/{Protheus.doc} XREQPRDE
Relatório - Requis. Producao 'DE'         
@author Nunes
@since 21/06/2019
@version 1.0
	@example
...
Static Function fReportDef()
	...
	oReport := TReport():New(	"XREQPRDE",;		//Nome do Relatório
								"Requis. Producao DE",;		//Título
...
Static Function fRepPrint(oReport)
	...
	cQryAux += "	  ORDER BY SB1.B1_TIPO,SB1.B1_TIPOBN,SB1.B1_CONTA,SD3.D3_EMISSAO,SD3.D3_COD ASC"		+ STR_PULA
