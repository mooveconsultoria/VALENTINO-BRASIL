...
/*/{Protheus.doc} XDEVEND
Relatório - Devolucao de Vendas           
@author Nunes
@since 21/06/2019
@version 1.0
	@example
...
Static Function fReportDef()
	...
	oReport := TReport():New(	"XDEVEND",;		//Nome do Relatório
								"Devolucao de Vendas",;		//Título
	...
	TRCell():New(oSectDad, "D1_NFORI", "QRY_AUX", "Docto. Orig.", /*Picture*/, 9, /*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign */,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,/*lBold*/)
	TRCell():New(oSectDad, "D1_SERIORI", "QRY_AUX", "Serie Orig.", /*Picture*/, 3, /*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign */,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,/*lBold*/)
...
Static Function fRepPrint(oReport)
	...
	cQryAux := ""
	cQryAux += "SELECT D1_FILIAL,D1_ITEM,D1_COD,B1_DESC,B1_TIPO,B1_TIPOBN,B1_CONTA,D1_UM,D1_QUANT,D1_VUNIT,D1_TOTAL,D1_TES,F4_TEXTO,D1_CF,D1_DOC,D1_SERIE,D1_EMISSAO,D1_DTDIGIT,D1_NFORI,D1_SERIORI,D1_FORNECE,D1_LOJA,A1_NREDUZ,D1_CUSTO FROM " + retSqlName("SD1") + " SD1"		+ STR_PULA
	...
	cQryAux += "   INNER JOIN " + retSqlName("SA1") + " SA1 ON SD1.D1_FORNECE+SD1.D1_LOJA=SA1.A1_COD+SA1.A1_LOJA"		+ STR_PULA
	...
	cQryAux += "	  GROUP BY SB1.B1_TIPO,SB1.B1_TIPOBN,SB1.B1_CONTA,SD1.D1_FILIAL,SD1.D1_ITEM,SD1.D1_COD,SB1.B1_DESC,SD1.D1_UM,SD1.D1_QUANT,SD1.D1_VUNIT,SD1.D1_TOTAL,SD1.D1_TES,SF4.F4_TEXTO,SD1.D1_CF,SD1.D1_DOC,SD1.D1_SERIE,SD1.D1_EMISSAO,SD1.D1_DTDIGIT,SD1.D1_NFORI,SD1.D1_SERIORI,SD1.D1_FORNECE,SD1.D1_LOJA,SA1.A1_NREDUZ,SD1.D1_CUSTO "		+ STR_PULA
