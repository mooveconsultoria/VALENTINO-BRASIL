...
/*/{Protheus.doc} xMovIntR
Relatório - Mov Interno Requiisicao s/OP
@author Nunes
@since 21/06/2019
@version 1.0
	@example
...
Static Function fReportDef()
	...
	oReport := TReport():New(	"xMovIntR",;		//Nome do Relatório
								"Mov Interno Requiisicao s/OP",;		//Título
...
Static Function fRepPrint(oReport)
	...
	cQryAux := ""
	cQryAux += "SELECT D3_FILIAL,D3_TM,D3_COD,B1_DESC,B1_TIPO,D3_UM,D3_QUANT,D3_CF,D3_LOCAL,D3_DOC,D3_OP,D3_EMISSAO,D3_CC,D3_USUARIO,D3_CUSTO1 FROM " + retSqlName("SD3") + " SD3"		+ STR_PULA
