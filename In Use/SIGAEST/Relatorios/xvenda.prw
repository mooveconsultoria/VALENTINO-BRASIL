...
Static Function fReportDef()
	...
	oReport := TReport():New(	"XVENDA",;		//Nome do Relatório
								"Vendas",;		//Título
...
Static Function fRepPrint(oReport)
	...
	cQryAux := ""
	cQryAux += "SELECT D2_FILIAL,D2_ITEM,D2_COD,B1_DESC,B1_TIPO,B1_TIPOBN,B1_CONTA,D2_UM,D2_QUANT,D2_PRCVEN,D2_TOTAL,D2_TES,F4_TEXTO,D2_CF,D2_DOC,D2_SERIE,D2_EMISSAO,D2_CLIENTE,D2_LOJA,A1_NREDUZ,D2_CUSTO1 FROM " + retSqlName("SD2") + " SD2"		+ STR_PULA
	...
	cQryAux += "   INNER JOIN " + retSqlName("SA1") + " SA1 ON SD2.D2_CLIENTE+SD2.D2_LOJA=SA1.A1_COD+SA1.A1_LOJA"		+ STR_PULA
	...
	cQryAux += "	  GROUP BY SB1.B1_TIPO,SB1.B1_TIPOBN,SB1.B1_CONTA,SD2.D2_FILIAL,SD2.D2_ITEM,SD2.D2_COD,SB1.B1_DESC,SD2.D2_UM,SD2.D2_QUANT,SD2.D2_PRCVEN,SD2.D2_TOTAL,SD2.D2_TES,SF4.F4_TEXTO,SD2.D2_CF,SD2.D2_DOC,SD2.D2_SERIE,SD2.D2_EMISSAO,SD2.D2_CLIENTE,SD2.D2_LOJA,SA1.A1_NREDUZ,SD2.D2_CUSTO1 "		+ STR_PULA
