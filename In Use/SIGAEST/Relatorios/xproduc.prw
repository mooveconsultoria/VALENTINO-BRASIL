...
Static Function fReportDef()
	...
	oReport := TReport():New(	"XPRODUC",;		//Nome do Relatório
								"Producao",;		//Título
...
Static Function fRepPrint(oReport)
	...
	cQryAux := ""
	cQryAux += "SELECT  D3_FILIAL,D3_TM,D3_COD,B1_DESC,B1_TIPO,D3_UM,D3_QUANT,D3_CF,D3_LOCAL,D3_DOC,D3_OP,D3_EMISSAO,D3_SEQCALC,D3_CUSTO1 FROM " + retSqlName("SD3") + " SD3"		+ STR_PULA
	...
	cQryAux += "      AND SD3.D3_CF      IN ('PR0','PR1')"		+ STR_PULA
