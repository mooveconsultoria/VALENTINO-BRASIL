...
/*/{Protheus.doc} xcompra
Relatório - Relatorio MATR320 - Compras   
@author Nunes
@since 02/07/2019
@version 1.0
	@example
...
Static Function fReportDef()
	...
	oReport := TReport():New(	"xcompra",;		//Nome do Relatório
								"Relatorio MATR320 - Compras",;		//Título
	...
	TRCell():New(oSectDad, "D1_D1_DOC", "QRY_AUX", "NumNF", /*Picture*/, 9, /*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign */,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,/*lBold*/)
	...
	TRCell():New(oSectDad, "D1_FORNECE", "QRY_AUX", "Cod.Fornedor", /*Picture*/, 6, /*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign */,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,/*lBold*/)
	TRCell():New(oSectDad, "D1_LOJA", "QRY_AUX", "Loja", /*Picture*/, 4, /*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign */,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,/*lBold*/)
	TRCell():New(oSectDad, "A2_NREDUZ", "QRY_AUX", "Nome Fornec.", /*Picture*/, 2, /*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign */,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,/*lBold*/)
	...
	TRCell():New(oSectDad, "D1_DOC", "QRY_AUX", "Numero Nota", /*Picture*/, 15, /*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign */,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,/*lBold*/)
	TRCell():New(oSectDad, "D1_SERIE", "QRY_AUX", "Serie NF", /*Picture*/, 15, /*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign */,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,/*lBold*/)
...
Static Function fRepPrint(oReport)
	...
	cQryAux := ""
	cQryAux += "SELECT D1_FILIAL,D1_DOC,D1_SERIE,D1_ITEM,D1_COD,B1_DESC,B1_TIPO,B1_TIPOBN,D1_UM,B1_CONTA,D1_QUANT,D1_VUNIT,D1_TOTAL,D1_TES,F4_TEXTO,D1_CF,SD1.D1_DTDIGIT,D1_FORNECE,D1_LOJA,A2_NREDUZ,D1_CUSTO,D1_DOC,D1_SERIE FROM " + retSqlName("SD1") + " SD1"		+ STR_PULA
	...
	cQryAux += "   INNER JOIN " + retSqlName("SA2") + " SA2 ON SD1.D1_FORNECE+SD1.D1_LOJA=SA2.A2_COD+SA2.A2_LOJA"		+ STR_PULA
	...
	cQryAux += "      AND SA2.A2_FILIAL  = '"+XFILIAL("SA2")+"'"		+ STR_PULA
	...
	cQryAux += "	  GROUP BY SB1.B1_TIPO,SB1.B1_TIPOBN,SB1.B1_CONTA, SD1.D1_FILIAL,SD1.D1_DOC,SD1.D1_SERIE,SD1.D1_ITEM,SD1.D1_COD,SB1.B1_DESC,SD1.D1_UM,SD1.D1_QUANT,SD1.D1_VUNIT,SD1.D1_TOTAL,SD1.D1_TES,SF4.F4_TEXTO,SD1.D1_CF,SD1.D1_DTDIGIT,SD1.D1_FORNECE,SD1.D1_LOJA,SA2.A2_NREDUZ,SD1.D1_CUSTO,SD1.D1_DOC,SD1.D1_SERIE"		+ STR_PULA
	cQryAux += "	  ORDER BY SB1.B1_TIPO ASC"		+ STR_PULA
