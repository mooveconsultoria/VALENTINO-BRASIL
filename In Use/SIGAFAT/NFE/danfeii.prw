...
If nTipo <> 1
	...
	Else
		...
		EndIf
	EndIf
	//Alteracao Mauricio TOTVSIP - Muda nome do arquivo gerado - 27/03/2020
	cNomeNovo := 'DANFE_'+MV_PAR01+'_'+MV_PAR03    
	cFilePrint := cNomeNovo     
	oDANFE:cFilePrint := oDANFE:cPathPrint+cNomeNovo+'.rel'
	oDANFE:cFileName := cNomeNovo+'.rel'
...
ElseIf nTipo == 1
	...
	//Alteracao Mauricio TOTVSIP - Muda nome do arquivo gerado - 27/03/2020
	//Adicionado também para nTipo = 1 - Rodrigo Stephanel TOTVSIP
	cNomeNovo := 'DANFE_'+MV_PAR01+'_'+MV_PAR03    
	cFilePrint := cNomeNovo     
	oDANFE:cFilePrint := oDANFE:cPathPrint+cNomeNovo+'.rel'
	oDANFE:cFileName := cNomeNovo+'.rel'
