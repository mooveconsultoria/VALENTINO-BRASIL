...
/*/{Protheus.doc} XMOVINTD
Relatório - Mov Interno Devolucao    
@author Nunes
@since 21/06/2019
@version 1.0
	@example
...
Static Function fReportDef()
	...
	oReport := TReport():New(	"XMOVINTD",;		//Nome do Relatório
								"Mov Interno Devolução s/OP",;		//Título
	...
	TRCell():New(oSectDad, "D3_CC", "QRY_AUX", "Centro Custo", /*Picture*/, 9, /*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign */,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,/*lBold*/)
...
Static Function fRepPrint(oReport)
	...
	cQryAux := ""
	cQryAux += "SELECT D3_FILIAL,D3_TM,D3_COD,B1_DESC,B1_TIPO,B1_TIPOBN,B1_CONTA,D3_UM,D3_QUANT,D3_CF,D3_LOCAL,D3_DOC,D3_OP,D3_EMISSAO,D3_CC,D3_USUARIO,D3_CUSTO1 FROM " + retSqlName("SD3") + " SD3"		+ STR_PULA
	...
	cQryAux += "      AND SD3.D3_CF      <> 'RE4'"		+ STR_PULA
	cQryAux += "      AND SD3.D3_CF      <> 'DE4'"		+ STR_PULA
	cQryAux += "      AND SD3.D3_TM      < '501'"		+ STR_PULA
	cQryAux += "      AND SUBSTRING(D3_CF,3,1) <> '3'"		+ STR_PULA
	...
	cQryAux += "	  GROUP BY SB1.B1_TIPO,SB1.B1_TIPOBN,SB1.B1_CONTA,SD3.D3_FILIAL,SD3.D3_TM,SD3.D3_COD,SB1.B1_DESC,SD3.D3_UM,SD3.D3_QUANT,SD3.D3_CF,SD3.D3_LOCAL,SD3.D3_DOC,SD3.D3_OP,SD3.D3_EMISSAO,SD3.D3_CC,SD3.D3_USUARIO,SD3.D3_CUSTO1 "		+ STR_PULA
